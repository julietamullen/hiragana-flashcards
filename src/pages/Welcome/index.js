...
function Welcome () {
    return (
        ...
        <div className="welcome-container">
            ...
            <p>In this app, you will find the flashcards sorted by groups (as most charts are). In the frontside of each flashcard you'll see the hiragana, and in the backside, the sound it is associated to. Just click/tap them to turn them around!</p>
            <p><b>がんばって!</b></p>
